...
For the price sectione put the price inside a span inside a div, then make the div display: flex and use align-item: center to align vertically "per month" to the price.
